...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#" onclick="areaVisualiza('./elements/table_areas.php')">Areas</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#" onclick="areaVisualiza('./elements/table_cursos.php')">Cursos</a>
            </li>
            <li class="nav-item">
